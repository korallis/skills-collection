...
second tracker when no tracker guide is present.
...
1. Issue references in the commit messages (`#123`, `Closes #45`, GitLab `!67`, etc.), resolved with
   the repository's documented tracker workflow or the tracker CLI already in use.
