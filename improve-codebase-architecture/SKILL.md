...
description: Identifies weak module boundaries and concrete deepening opportunities in a codebase, with a visual report to choose from. Use when the user asks where the architecture is weak, wants module boundaries improved, says improve the architecture, or asks what to refactor next.
---
